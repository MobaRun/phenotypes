...
q2_beregning_raw_table_path <- args[12]
q3_raw_table_path <- args[13]
q4_raw_table_path <- args[14]
q5_raw_table_path <- args[15]
q6_raw_table_path <- args[16]
q7_raw_table_path <- args[17]
q8_raw_table_path <- args[18]
q9_raw_table_path <- args[19]
kostUngdom_raw_table_path <- args[20]
ungdomsskjema_barn_raw_table_path <- args[21]
tablesFolder <- args[22]
qcFolder <- args[23]
project_number <- args[24]
